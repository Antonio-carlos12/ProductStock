const openModal = () => document.getElementById('estoqueModal')
...
const createRow = (client, index) => {
    ...
    newRow.innerHTML = `
        ...
        <td>
            <button type="button" data-bs-toggle="modal" data-bs-target="#estoqueModal" class="btn btn-success" id="edit-${index}">Editar</button>
...
function verifica(db_client){
    let storageValue = db_client
    if(storageValue.get('nome')){
        console.log("ter");
     }
